# whats-next — delta spec

Scope note: this spec covers only the requirements this change establishes for the whats-next skill
(`skills/whats-next/SKILL.md`); it is not a retroactive full spec of the skill.
